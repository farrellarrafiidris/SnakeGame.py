...
def next_turn(snake1, snake2, foods):
    ...
    if check_collision(snake1) or check_collision(snake2) or check_snake_collision(snake1, snake2):
        ...
        window.after(GAME_SPEED, next_turn, snake1, snake2, foods)
...
def restart_game():
    global snake1, snake2, foods, score, direction1, direction2
